...
# in forms.py
from .profile import MyForm, PhotoForm
...
def profile():
    ...
    if request.method=='POST':
        if myform.validate_on_submit():
            ...
            return render_template('profiles.html',firstname=firstname, lastname=lastname,gender=gender, email=email, location=location, biography=biography,profilepic=profilepic)
        flash_errors(myform)
